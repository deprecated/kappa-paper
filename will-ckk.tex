...
\end{figure}
% \begin{table}
%   \caption{Asymptotic behaviors of relaxation timescales}
% \end{table}
...
leading to zero net contribution to \dfudt{inelastic}.  
...
emission of the strong \Wav{5007}, \Wav{4959} nebular lines, and the
weaker \Wav{4363} auroral line.  Results are shown in
